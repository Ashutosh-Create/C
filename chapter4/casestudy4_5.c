...
main(void)
{
  int previous, // prevoius meter reading
	  used, //gallons of water used 
	  current; // cuurrent meter reading
  double unpaid, //previous unpaid balance
		 bill, //water bill
		 use_charge,//charge for water use
		 late_charge; //charge foer non paym,ent of prevoius bill
  instruct_water();
